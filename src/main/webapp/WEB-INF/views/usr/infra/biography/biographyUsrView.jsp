...
<body>
  ...
  <main id="main">
    ...
    <section id="portfolio" class="portfolio" style="background-color:#ccc;">
      <div class="container">
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-Personal">
            ...
            <div class="portfolio-info">
              ...
              <a href="" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Personal 1">
          ...
          <div class="col-lg-3 col-md-2 portfolio-item filter-Personal">
            ...
            <div class="portfolio-info">
              ...
              <a href="" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Personal 2">
              	<i class="bx bx-plus"></i>
              </a>
          ...
          <div class="col-lg-6">
            ...
            <div class="resume-item pb-0">
              ...
              <ul>
                <li>경기 김포</li>
                <li>010-2950-3553</li>
                <li>ssk3553@naver.com</li>
              </ul>
              
            </div>

            <h3 class="resume-title">b</h3>
            <div class="resume-item">
              <h4>풍무고등학교 졸업</h4>
              <h5>2009 - 2012</h5>
            </div>
            <div class="resume-item">
              <h4>김포 이젠 컴퓨터 아카데미 </h4>
              <h5>2023</h5>
              <p>풀스택 자바웹개발자</p>
              <p></p>
            </div>
