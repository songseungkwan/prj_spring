	...
	<div class="container" id="blackFonts">
		...
		<div class="collapse navbar-collapse justify-content-end"
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link" rel="tooltip"
					title="내 정보" data-placement="bottom" href="" target="_blank"> <i
						class="fa-regular fa-user"></i>
						<p class="d-lg-none">내 정보</p>
				</a></li>
				
				<li class="nav-item"><a href="usrRegisterForm" class="nav-link">회원가입</a>
				</li>

				<li class="nav-item"><a href="usrLoginForm" class="nav-link">로그인</a>
				</li>
