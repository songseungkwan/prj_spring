...
<head>
    ...
    <link rel="stylesheet" href="resources/ash_assets/css/style03.css">
    <!-- Responsive css -->
...
<body>
    <div id="wrap">
        ...
        <nav class="navbar navbar-expand-lg fixed-top navbar-transparent" color-on-scroll="300">
          ...
          <li class="nav-item">
          <a class="nav-link" rel="tooltip" title="종목" data-placement="bottom" href="workout.html" target="_blank">
