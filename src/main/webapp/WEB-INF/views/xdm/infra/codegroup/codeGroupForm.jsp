...
<body>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
            ...
            <li class="message-item">
              <a href="#">
                <img src="resources/adminAssets/img/messages-1.jpg" alt="" class="rounded-circle">
                <div>
                  <h4>Maria Hudson</h4>
            ...
            <li class="message-item">
              <a href="#">
                <img src="resources/adminAssets/img/messages-2.jpg" alt="" class="rounded-circle">
                <div>
                  <h4>Anna Nelson</h4>
                  <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                  <p>6 hrs. ago</p>
            ...
            <li class="message-item">
              <a href="#">
                <img src="resources/adminAssets/img/messages-3.jpg" alt="" class="rounded-circle">
                <div>
                  <h4>David Muldon</h4>
                  <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                  <p>8 hrs. ago</p>
  ...
  <main id="main" class="main">
    ...
    <div class="row">
	    ...
	    <input type="text" class="form-control form-control-lg" id="seq" name="seq" readonly value="<c:out value="${item.seq}"/>"	    >
	    </div>
	    
	    <div class="col-3">                			
	    <label for="name" class="form-label">name</label>
	    <input type="text" class="form-control form-control-lg" id="name" name="name" value="<c:out value="${item.name}"/>" 	    >
	    </div>
	    
	    <div class="col-3">   
	    <label for="delNy" class="form-label">delNy</label>
	    <input type="text" class="form-control form-control-lg" id="delNy" name="delNy"  value="<c:out value="${item.delNy}"/>" 	    >
	    </div>
		

		<div class=" col-3 gap-2 d-md-flex justify-content-md-end">
...
<br>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>King-Petition</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
