      ...
      <div class="row">
		...
		<!-- 검색창에 입력하면 내용값 그대로 검색창에 띄우기 -->
	                ...
	                <div class="col-4">
	                  ...
	                  <a href="/competitionXdmForm"><button class="btn btn-danger addBtn" type="button">추가</button></a>
	                  
	                  <a href="/competitionXdmList"><button class="btn btn-warning btnInit " type="button">Init</button></a>
	                </div>
	              </div>
...
<%@include file = "../include/includeJs.jsp"%>
  ...
  <script type="text/javascript">
		 ...
		 $("#btnSearch").on("click", function() {
		 	$("form[name=formList]").attr("action", "/competitionXdmList").submit();
		 });
		 /* 추가버튼 */
